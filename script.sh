...
docker pull ${DOCKER_REPO}:6.${latest_commit_hash}
docker run -p ${HOST_PORT}:${HOST_PORT} --env-file=${ENV_FILE} ${DOCKER_REPO}:6.${latest_commit_hash}
